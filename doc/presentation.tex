...
Algorithm of choice when sampling gauge configurations.
\end{frame}


\begin{frame}{The path integral I}
\only<1>{\begin{align*}
    \langle O \rangle = \frac{1}{Z} \int \mathcal{D}A \mathcal{D}\bar{\psi} \mathcal{D}\psi O[\psi,\bar{\psi},A] \e^{- S_G[A] - S_F[\psi,\bar{\psi},A]}.
\end{align*}}%
\only<2>{\begin{align*}
    \langle O \rangle = \frac{1}{Z} \int \mathcal{D}A O[\psi,\bar{\psi},A] \e^{- S_G[A]}.
\end{align*}}%
\only<3>{\begin{align*}
    \langle O \rangle = \mathcolor{red}{\frac{1}{Z} \int \mathcal{D}A} O[\psi,\bar{\psi},A] \mathcolor{red}{\e^{- S_G[A]}}.
\end{align*}}%
with 
\only<1>{\begin{align*}
Z = \int \mathcal{D}A \mathcal{D}\bar{\psi} \mathcal{D}\psi e^{- S_G[A] - S_F[\psi,\bar{\psi}, A]}.
\end{align*}}%
\only<2->{\begin{align*}
Z = \int \mathcal{D}A e^{- S_G[A]}.
\end{align*}}%
\end{frame}
