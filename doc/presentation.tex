...
\begin{figure}
    \includegraphics{../figures/illustrations/lqcd/clover/clover.pdf}
\end{figure}
\note{
\begin{itemize}
...
\husk{TODO: Flytte den delen til der jeg presenterer Witten-Veneziano-formelen.}
...
\end{itemize}
\note{
    \husk{TODO: MORE ON WV FORMULA. CLARIFY WHAT IT IS AND WHAT IT EXPLAINS.}
    \begin{itemize}
...
\husk{TODO: WHAT DO THE R RATIO INDICATE WHEN AWAY FROM ZERO?!}
\begin{align*}
...
\husk{TODO: WHAT ARTICLE?! SCALE TABLE}
\only<1>{\begin{table}
    \centering
    \begin{tabular}{l r r r r r r r}
        \toprule
...
\husk{TODO: CLEAN UP! REMOVE GENERAL EXPRESSION(ITS JUST MORE CONFUSING!)}
\husk{TODO: EXPLAIN HERE WHAT SOURCE/SINK IS}
