...
\begin{columns}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.95\textwidth]{../figures/running_coupling_qed_qcd.pdf}
    \end{figure}
...
\onslide<3->{Action given in terms of spacetime integral of the Lagrangian $\mathcal{L}$ \begin{align*}
...
\end{align*}}
\onslide<6->{From this we can build a lattice action,
\begin{align*}
...
\end{figure}}
\onslide<2-2>{Continuum extrapolation using ensembles $A$, $B$, $C$, and $D_2$ gives $t_{0,\mathrm{cont}}/r_0^2 = 0.11087(50)$.}
